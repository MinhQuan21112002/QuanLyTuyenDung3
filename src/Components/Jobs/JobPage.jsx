...
const JobPage = () => {
  ...
  return (
    <>
      <h1></h1>
      <Box ml='10' mt='120px' fontWeight='bold' width='60%' fontSize='20px'>{jobData.length} Jobs Based on your interest</Box>
      <Box display='flex' justifyContent='space-between' >
      
      
      
     <SimpleGrid  w="100%" top="50" left="50" ml='10' mt="50px" mr="10"columns={3} spacing={"10"}>{jobdatas} </SimpleGrid>
