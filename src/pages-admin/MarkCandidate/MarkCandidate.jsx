...
export const MarkCandidate = () => {
    ...
    useEffect(() => {
        interviewService
            .getInterviewByID(accessToken, params.roomId)
    ...
    useEffect(() => {
        if (selected === 0) {
            ...
            interviewDetailService
                .getInterviewDetailById(accessToken, selected)
                .then((response) => setInterviewDetail(response));
        }
    }, [selected]);
